...
class _chargerScreenState extends State<chargerScreen> {
  ...
  FirebaseFirestore.instance.collection('Product').orderBy('char');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Charger Controller',style: TextStyle(color: Colors.white),),backgroundColor: Color(0xFF07A66FF),),
      body: StreamBuilder(
