...
class _cellScreenState extends State<cellScreen> {
  ...
  FirebaseFirestore.instance.collection('Product').orderBy('solar');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Solar Panel',style: TextStyle(color: Colors.white),),backgroundColor: Color(0xFF07A66FF),),
      body: StreamBuilder(
