...
class _batteryScreenState extends State<batteryScreen> {
  ...
  Query<Map<String, dynamic>> product =
      FirebaseFirestore.instance.collection('Product').orderBy('battery');

  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
                iconTheme: const IconThemeData(color: Colors.white),
        title: Text('Batteries',style: TextStyle(color: Colors.white),),backgroundColor: Color(0xFF07A66FF),),
      body: StreamBuilder(
